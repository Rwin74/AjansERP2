    ...
    <div className="flex flex-col w-full h-full bg-[#000000] text-white">
      ...
      <header className="glass-header px-8 py-6 sticky top-0 z-40">
        <div className="flex justify-between items-end">
          <div>
            <h1 className="text-3xl font-bold tracking-tight text-gradient mb-1">SEO Yönetimi</h1>
            <p className="text-sm text-gray-400 mb-4">Müşteri Bazlı SEO ve Analiz Paneli</p>
            <ClientSelector />
          </div>
